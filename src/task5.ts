...
export const firstUp: StringFormatter = (str: string, uppercase: boolean = false): string => {
    if (str.length === 0) return str;

    return str.charAt(0).toUpperCase() + str.slice(1);
};

export const delSpaceAnduppercase: StringFormatter = (str: string, uppercase: boolean = false): string => {
